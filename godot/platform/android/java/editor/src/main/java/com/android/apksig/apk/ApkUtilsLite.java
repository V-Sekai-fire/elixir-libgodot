...
public class ApkUtilsLite {
	...
	public static ZipSections findZipSections(DataSource apk)
		...
		if (cdStartOffset > eocdOffset) {
			throw new ZipFormatException(
					"ZIP Central Directory start offset out of range: " + cdStartOffset + ". ZIP End of Central Directory offset: " + eocdOffset);
		}
		...
		if (cdEndOffset > eocdOffset) {
			throw new ZipFormatException(
					...
					+ ". CD end: " + cdEndOffset + ", EoCD start: " + eocdOffset);
		}
	...
	public static ApkSigningBlock findApkSigningBlock(DataSource apk, ZipSections zipSections)
		...
		if (centralDirStartOffset < APK_SIG_BLOCK_MIN_SIZE) {
			throw new ApkSigningBlockNotFoundException(
					"APK too small for APK Signing Block. ZIP Central Directory offset: " + centralDirStartOffset);
		}
