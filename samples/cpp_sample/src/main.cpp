...
public:
  LibGodot(std::string p_path = LIBGODOT_LIBRARY_NAME) {
    ...
    *(void **)(&func_libgodot_create_godot_instance) =
    ...
    *(void **)(&func_libgodot_destroy_godot_instance) =
        dlsym(handle, "libgodot_destroy_godot_instance");
  ...
  godot::GodotInstance *
  create_godot_instance(int p_argc, char *p_argv[],
                        GDExtensionInitializationFunction p_init_func =
                            gdextension_default_init) {
    if (!is_open()) {
      return nullptr;
    }
    GDExtensionObjectPtr instance = func_libgodot_create_godot_instance(
        p_argc, p_argv, p_init_func, nullptr, nullptr, nullptr, nullptr,
        nullptr, nullptr);
    if (instance == nullptr) {
      return nullptr;
    }
...
int main(int argc, char **argv) {
  ...
  godot::GodotInstance *instance =
      libgodot.create_godot_instance(argvs.size(), argvs.data());
  if (instance == nullptr) {
